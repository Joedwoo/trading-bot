...
class Agent:
    ...
    def predict_with_q_values(self, state):
        """Predicts an action and returns Q-values for API."""
        if not hasattr(self, 'model'):
            raise ValueError("Model not loaded. Please initialize agent with pretrained=True and a valid model_name.")
